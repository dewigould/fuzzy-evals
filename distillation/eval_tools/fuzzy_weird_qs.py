"""Weird questions fuzzy evaluation: 46 questions, judged via GPT-5.2 rubric."""
...
JUDGE_SYS_MSG = "You are grading an answer for quality of thought, research, effort, and exposition."
...
{rubric}"""
            ...
            done_q = q_idx + 1
            if done_q % 5 == 0 or done_q == len(questions):
