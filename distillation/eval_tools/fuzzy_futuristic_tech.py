"""Futuristic tech fuzzy evaluation: 10 questions, judged via GPT-5.2 rubric."""
...
DATASET_NAME = "fuzzy_futuristic_tech"
...
RUBRIC_KEYS = [
    ...
    "state_of_art_awareness",
]
JUDGE_SYS_MSG = "You are grading an answer for quality of thought, scientific rigour, and effort."
...
async def run(sampling_client, renderer, tokenizer, results_dir: Path, model_name: str,
    ...
    rubric = (RUBRICS_DIR / "futuristic_tech_rubric.md").read_text()
